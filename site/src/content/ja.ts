...
export const ja: SiteContent = {
  ...
  privacy: {
    ...
    sections: [
      ...
      {
        title: 'あなたの訪問は匿名のままです',
        body: '本サイトは静的サイトです：Cookie を使わず、サードパーティのスクリプトも読み込まず、フォントや素材もすべてセルフホストしています。アクセス数は自社サーバー上で匿名集計——個人を特定せず、クロスサイト追跡もなく、第三者とも共有しません。それ以外は、ファイルをいくつか読むだけ——それ以上のことは何もありません。',
      },
      {
