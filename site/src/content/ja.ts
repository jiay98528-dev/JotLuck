...
export const ja: SiteContent = {
  ...
  download: {
    ...
    lead: 'v0.15 Preview は macOS Apple Silicon 向けに公開中です。Windows x64 と Linux x86_64 はアーカイブ済み v0.14 Preview を引き続き利用できます。ノートはすべてローカルファイルです。',
    statusLabel: '最初のプラットフォーム',
    statusValue: 'macOS Apple Silicon',
    platformTitle: 'プラットフォーム',
    platforms: [
      { name: 'Windows x64', state: 'アーカイブ v0.14 Preview' },
      { name: 'macOS Apple Silicon', state: 'v0.15 Preview 公開中' },
      { name: 'Linux x86_64', state: 'アーカイブ v0.14 Preview' },
    ],
    honestyTitle: 'Preview 先行。',
    honestyBody:
      'Preview インストーラーはすでに GitHub Releases に公開されています——ダウンロード可能、検証可能、巻き戻し可能。',
    previewTitle: 'v0.15.0 Preview · Mac 先行',
    previousVersionLabel: 'アーカイブ済み v0.14 Preview',
    ...
    downloadBtnMacMirror: 'Mac 公式ミラー',
    githubBtn: 'GitHub',
