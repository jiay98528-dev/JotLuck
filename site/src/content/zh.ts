...
export const zh: SiteContent = {
  meta: {
    ...
    pageDescriptions: {
      ...
      privacy:
        'JotLuck 隐私说明：这款开源 Markdown 笔记软件完全离线运行，笔记以纯文本文件保存在你自己的文件夹中——写作无需账号、无遥测。本站为静态网站，不使用 Cookie，无第三方追踪。',
      changelog:
  ...
  privacy: {
    ...
    sections: [
      ...
      {
        title: '你的访问保持匿名',
        body: '本站是静态网站：不使用 Cookie，不加载第三方脚本，字体与素材全部自托管。访问量在我们的自有服务器上匿名统计——不识别个人、不跨站追踪、不向第三方发送。除此之外，你的访问只是读走几个文件，仅此而已。',
      },
      {
        title: '下载与 GitHub',
