...
export const ko: SiteContent = {
  ...
  privacy: {
    ...
    sections: [
      ...
      {
        title: '당신의 방문은 익명으로 유지됩니다',
        body: '이 사이트는 정적 사이트입니다: Cookie를 쓰지 않고, 서드파티 스크립트도 불러오지 않으며, 글꼴과 에셋도 모두 자체 호스팅합니다. 방문 수는 자체 서버에서 익명으로 집계——개인 식별 없이, 교차 사이트 추적 없이, 제3자와 공유하지 않습니다. 그 외에는 파일 몇 개를 읽는 것뿐——그 이상은 아무것도 아닙니다.',
      },
      {
        title: '다운로드와 GitHub',
