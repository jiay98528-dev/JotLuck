...
export const ko: SiteContent = {
  ...
  download: {
    ...
    lead: 'v0.15 Preview는 macOS Apple Silicon용으로 공개되었습니다. Windows x64와 Linux x86_64는 보관된 v0.14 Preview를 계속 사용할 수 있습니다. 노트는 모든 시스템에서 로컬 파일로 남습니다.',
    statusLabel: '첫 번째 플랫폼',
    statusValue: 'macOS Apple Silicon',
    platformTitle: '플랫폼',
    platforms: [
      { name: 'Windows x64', state: '보관된 v0.14 Preview' },
      { name: 'macOS Apple Silicon', state: 'v0.15 Preview 공개 중' },
      { name: 'Linux x86_64', state: '보관된 v0.14 Preview' },
    ],
    honestyTitle: 'Preview가 먼저입니다.',
    honestyBody:
      'Preview 설치 파일은 이미 GitHub Releases에 공개되었습니다——다운로드 가능하고, 검증 가능하며, 되돌릴 수 있습니다.',
    previewTitle: 'v0.15.0 Preview · Mac 우선',
    previousVersionLabel: '보관된 v0.14 Preview',
    downloadBtn: 'Preview 다운로드（Windows x64）',
    downloadBtnLinux: 'Preview 다운로드（Linux .deb）',
    downloadBtnMac: 'Preview 다운로드（macOS .dmg）',
    downloadBtnMacMirror: 'Mac 공식 미러',
    githubBtn: 'GitHub',
