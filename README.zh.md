...
当前源码版本：`v0.13.1-preview`，Windows 公开预览版。经过完整测试，代码签名正在处理中。

> **下载提示：** 官方安装包只会出现在 [GitHub Releases](https://github.com/jiay98528-dev/JotLuck/releases)。`v0.13.1-preview` 安装包尚未上架；上架的安装包均未签名——安装前请核对 SHA-256。请勿从其他任何渠道下载 JotLuck。
