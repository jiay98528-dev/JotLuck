...
Current source version: `v0.15.0-preview`, a Mac-only preview release. The v0.15 Preview targets macOS Apple Silicon; Windows x64 and Linux x86_64 remain available from the archived v0.14 Preview.

> **Download notice:** The `v0.15.0-preview` macOS Apple Silicon package is published on [GitHub Releases](https://github.com/jiay98528-dev/JotLuck/releases/tag/v0.15.0-preview). The artifact is `JotLuck_0.15.0-preview_aarch64.dmg`, 41,897,879 bytes, SHA-256 `66f17129390ce7ce398ca20a520e1c3d59a6ca110fed896e4f507e5ab04d6561`. The official website manifest and direct Mac mirror are live and verified. Do not download JotLuck from anywhere else.
...
| Candidate platform       | macOS Apple Silicon v0.15 Preview published; Windows x64 and Linux x86_64 remain archived v0.14 Preview                       |
